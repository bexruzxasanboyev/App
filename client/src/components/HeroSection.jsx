...
const HeroSection = () => {
  ...
  return (
    ...
    >
      ...
      <button onClick={()=> navigate('/movies')} className='flex items-center gap-1 px-6 py-3 text-sm bg-primary hover:bg-primary-dull transition rounded-full font-medium cursor-pointer duration-300'>
        Explore Movies
        <ArrowRight />
      </button>
    </div>
